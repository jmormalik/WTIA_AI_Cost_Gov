...
2차 reset (2026-08-03, 멘토링 세션): AI-native → **비 AI-native 중견기업**으로 전환.

- **① ICP: AI-native scaleup → 비 AI-native 중견기업 (AX 전환 + 멀티 기능 롤아웃 단계).** 월 AI 지출 $100K+, 200~2,000명, AI 벤더 3개+ 동시 운영. 초기 니치 = 운송·물류. 전환 이유: (a) AI-native는 자체구축 가능·선호 → "직접 만들지" 반론 성립. (b) 비 AI-native는 AI 엔지니어링 DNA 없어 구조적 자체구축 불가 → 반론 소멸. (c) 비 AI-native 기업 수 >> AI-native → 시장 모집단 크다. Korean AI startups = **free design partners** (역할 유지).
